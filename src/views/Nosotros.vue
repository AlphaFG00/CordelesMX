...
<style>
  ...
  .li-1{
    opacity: 0;
    animation: show-list-part 1s 3.5s forwards;
  }

  .li-2{
    opacity: 0;
    animation: show-list-part 1s 4s forwards;
  }
  .li-3{
    opacity: 0;
    animation: show-list-part 1s 4.5s forwards;
  }
  .li-4{
    opacity: 0;
    animation: show-list-part 1s 5s forwards;
  }
.cuarta-parte{
      opacity: 0;
      padding: 1.1ex;
