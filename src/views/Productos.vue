        ...
        return {
            ...
            productos:[
                ...
                [
                    ...
                    [
                        {costal:'TRIGUERO','medida(CM)':'70x110',peso:'900 g',capacidad:'100 kg'},
                        {costal:'BURRERO','medida(CM)':'60x100',peso:'760 g',capacidad:'100 kg'},
                        {costal:'CACAO','medida(CM)':'70x110',peso:'800 g',capacidad:'100 kg'},
                        {costal:'ZANAHORIA','medida(CM)':'67x100',peso:'640 g',capacidad:'100 kg'},
                        {costal:'MAÍZ-FRIJOL','medida(CM)':'62x102',peso:'750 g',capacidad:'100 kg'},
                        {costal:'JICAMA','medida(CM)':'65x100',peso:'500 g',capacidad:'100 kg'},
                        {costal:'DOBLE PIE','medida(CM)':'70x100',peso:'1250 g',capacidad:'50 kg'},
                        {costal:'CEBOLLA','medida(CM)':'60x80',peso:'300 g',capacidad:'100 kg'},
                        {costal:'PERGAMINO','medida(CM)':'70x110',peso:'1000 g',capacidad:'100 kg'},
                        {costal:'CAFETERO','medida(CM)':'70x100',peso:'950 g',capacidad:'50 kg'},
                    ],
                ...
                [
                    ['costal','medida(CM)','peso','capacidad'],
                    [
                        {costal:'NUEVO','medida(CM)':'70x110',peso:'930 g',capacidad:'70 kg'},
                        {costal:'USADO','medida(CM)':'65x100',peso:'750 g',capacidad:'60 kg'},
                        {costal:'DELGADO','medida(CM)':'60x110',peso:'500 g',capacidad:'60 kg'},
                        {costal:'CACAHUATERO','medida(CM)':'55x100',peso:'750 g',capacidad:'50 kg'},
                    ],
