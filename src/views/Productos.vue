    ...
    data(){
        return {
            ...
            productos:[
                ...
                [
                    ['costal','medida(CM)','peso_grms','capacidad'],
                    [
                        {costal:'TRIGUERO','medida(CM)':'70x110',peso_grms:'900 g',capacidad:'100 kg'},
                        {costal:'BURRERO','medida(CM)':'60x100',peso_grms:'760 g',capacidad:'100 kg'},
                        {costal:'CACAO','medida(CM)':'70x110',peso_grms:'800 g',capacidad:'100 kg'},
                        {costal:'ZANAHORIA','medida(CM)':'67x100',peso_grms:'640 g',capacidad:'100 kg'},
                        {costal:'MAÍZ-FRIJOL','medida(CM)':'62x102',peso_grms:'750 g',capacidad:'100 kg'},
                        {costal:'JICAMA','medida(CM)':'65x100',peso_grms:'500 g',capacidad:'100 kg'},
                        {costal:'DOBLE PIE','medida(CM)':'70x100',peso_grms:'1250 g',capacidad:'50 kg'},
                        {costal:'CEBOLLA','medida(CM)':'60x80',peso_grms:'300 g',capacidad:'100 kg'},
                        {costal:'PERGAMINO','medida(CM)':'70x110',peso_grms:'1000 g',capacidad:'100 kg'},
                        {costal:'CAFETERO','medida(CM)':'70x100',peso_grms:'950 g',capacidad:'50 kg'},
                    ],
                ...
                [
                    ['costal','medida(CM)','peso_grms','capacidad'],
                    [
                        {costal:'NUEVO','medida(CM)':'70x110',peso_grms:'930 g',capacidad:'70 kg'},
                        {costal:'USADO','medida(CM)':'65x100',peso_grms:'750 g',capacidad:'60 kg'},
                        {costal:'DELGADO','medida(CM)':'60x110',peso_grms:'500 g',capacidad:'60 kg'},
                        {costal:'CACAHUATERO','medida(CM)':'55x100',peso_grms:'750 g',capacidad:'50 kg'},
                    ],
